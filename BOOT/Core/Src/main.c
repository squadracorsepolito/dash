...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : AMI3_CMD_Pin EBS_RELAY2_CMD_Pin EBS_RELAY1_CMD_Pin BUZZERAS_CMD_Pin */
  ...
  /*Configure GPIO pins : COCK_BTN_Pin MISSION_BTN_Pin */
  GPIO_InitStruct.Pin = COCK_BTN_Pin|MISSION_BTN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : AMS_CMD_Pin BUZZEREV_CMD_Pin IMD_CMD_Pin ASB_CMD_Pin
                           INVERTER_PUMP_PWM_CMD_Pin TSOFF_CMD_Pin RTD_CMD_Pin LED1_Pin
  ...
  /*Configure GPIO pins : AMI1_CMD_Pin ASSI_BLUE_CMD_Pin */
