...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM15_MspPostInit 0 */
    ...
    PA1     ------> TIM15_CH1N
    */
    GPIO_InitStruct.Pin = ASB_SERVO_PWM_CMD_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF9_TIM15;
    HAL_GPIO_Init(ASB_SERVO_PWM_CMD_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM16_MspPostInit 0 */
    ...
    PB8     ------> TIM16_CH1
    */
    GPIO_InitStruct.Pin = BAT_FAN_PWM_CMD_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM16;
    HAL_GPIO_Init(BAT_FAN_PWM_CMD_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM17_MspPostInit 0 */
    ...
    PB9     ------> TIM17_CH1
    */
    GPIO_InitStruct.Pin = RADIATOR_FANS_PWM_CMD_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM17;
    HAL_GPIO_Init(RADIATOR_FANS_PWM_CMD_GPIO_Port, &GPIO_InitStruct);
...
{
    if (htim->Instance == INVERTER_PUMP_TIM.Instance && htim->Channel == INVERTER_PUMP_CH)
    {
        // Bit bang PWM
